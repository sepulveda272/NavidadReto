...
export default function (cualNotificacion, nombre, Apellido, empresa, email_contacto, telefono_contacto) {
        ...
        <div style="width: 100%; background-color: #e3e3e3;">
            <div style="padding: 20px 10px 20px 10px;">
                ...
                <div style="background-color: #282828; color: #ffffff; padding: 5px 0px 0px 0px; width: 100%; text-align: center;">
                    ...
                    <a href="https://wa.me/573118807659" class="contA"><img src="cid:wapp" class="imag" /></a>
    ...
    {
        filename: 'fb.png',
        path: '../BackEnd/functions/img/fb.png',
        cid: 'fb' //same cid value as in the html img src
    },
    {
        filename: 'em.png',
        path: '../BackEnd/functions/img/em.png',
        cid: 'em' //same cid value as in the html img src
    },
    {
        filename: 'ig.png',
        path: '../BackEnd/functions/img/ig.png',
        cid: 'ig' //same cid value as in the html img src
    },
    {
        filename: 'wapp.png',
        path: '../BackEnd/functions/img/wapp.png',
        cid: 'wapp' //same cid value as in the html img src
    },
    {
        filename: 'flogo-vertical-campus.png',
        path: '../BackEnd/functions/img/logo-vertical-campus.png',
        cid: 'logo-vertical-campus' //same cid value as in the html img src
    }
    ],
    }).then(info => {
    console.log({info});
